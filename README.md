...
Slide Roller is a macOS Electron app for running up to 4 simultaneous image and video playlist players with independent control, scheduling, and output routing.
